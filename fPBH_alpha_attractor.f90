...
program fPBH_alpha_attractor
    ...
    do i = 1, nfPBH
        ...
        write(11, "(2e25.16)") array_MtoMSun(i), array_fPBH(i)

        ! Use this to determine kinitial and kfinal:
        ! write(11, "(2e25.16)") k_i, array_fPBH(i)
    end do

    close(11)

    write(*, *)
    write(*, "(1a25, 1es25.16)") "MtoMSun_peak = ", array_MtoMSun(maxloc(array_fPBH))
    write(*, "(1a25, 1es25.16)") "fPBH_peak = ", maxval(array_fPBH)

end program fPBH_alpha_attractor
